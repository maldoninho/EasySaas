...
type AccountData={profile:{name:string;email:string;theme:string;locale:string;timezone:string};mfa:Array<{id:string;type:string;label:string;verified_at?:string}>};
